...
CREATE TABLE `tb_about` (
  ...
  `site_email` VARCHAR(120) NULL,
  `site_welcome` LONGTEXT NULL,
  `site_max_lent_books` TINYINT(1) NOT NULL DEFAULT 2)
ENGINE = InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `tb_about`(`site_shortname`, `site_longname`, `site_meta_description`, `site_meta_keywords`, `site_logo_url`, `site_email`, `site_welcome`) VALUES ('EasyBiblio','EasyBiblio - A Book Lending System made easy.','EasyBiblio - A Book Lending System made easy.','easybiblio','email@site.com','','<h1>Welcome to EasyBiblio Installation</h1>Put here custom information about your library (address, opening hours, rules for renting books, etc).');
